...
namespace TIM
{
    ...
    {
        [FoldoutGroup("Events")] public UnityEvent<bool> ToggleEvent = new UnityEvent<bool>();

        [FoldoutGroup("Formulas")] public CmdFormula ClearFormula;
        
        [FoldoutGroup("Links")] public CommandsList CommandsList;
        [FoldoutGroup("Links")] public ConsoleInputPanel InputPanel;
        [FoldoutGroup("Links")] public GameObject GlobalWindow;
        [FoldoutGroup("Links")] public LogchainWindow LogchainWindow;
        [FoldoutGroup("Links")] public ConsoleMessageInspector MessageInspector;
        [FoldoutGroup("Links")] public ConsoleConfigurator ConsoleConfigurator;
        [FoldoutGroup("Links")] public ConsoleMessagesContent MessagesContent;
        [FoldoutGroup("Links")] public ConsoleAudio ConsoleAudio;
        [FoldoutGroup("Links")] public Animation Animation;
        [FoldoutGroup("Links")] public EventSystem EventSystem;
        ...
        public void PrintMessage(string title, MessageType messageType, string stacktrace, string logchain = null, bool hidden = false)
        {
            ...
            switch (messageType)
            {
                case MessageType.Default: MessageCount_Default++;
                    break;
                case MessageType.Error: MessageCount_Error++;
                    break;
                case MessageType.Warning: MessageCount_Warning++;
                    break;
                case MessageType.Network: MessageCount_Network++;
                    break;
                default:
