...
namespace Demo
{
    ...
    {
        [BoxGroup("0", false)] public CmdFormula SpawnPlayerFormula;
        [BoxGroup("1", false)] public CmdFormula ChangePlayerColorFormula;
        [BoxGroup("2", false)] public CmdFormula SpawnBallsFormula;
        [BoxGroup("3", false)] public CmdFormula SetBallsDebugFormula;

        [FoldoutGroup("Links")] public TMP_Text CommandsListText;
        [FoldoutGroup("Links")] public DemoPlayer PlayerPrefab;
        [FoldoutGroup("Links")] public GameObject BallPrefab;
