...
namespace TIM
{
    ...
    {
        [BoxGroup, SerializeField] private TMP_Text _titleText;
        [BoxGroup, SerializeField] private TMP_Text _stacktraceText;
        [BoxGroup, SerializeField] private GameObject _logchainButton;
        [BoxGroup, SerializeField] private TMP_Text _logchainText;
        [BoxGroup, SerializeField] private Image _bgImage;
        [BoxGroup, SerializeField] private Image _downlineImage;
        [BoxGroup, SerializeField] private CanvasGroup _canvasGroup;
        [BoxGroup, SerializeField] private Animation _animation;
        [BoxGroup, SerializeField] private Image _openLogchainBgImage;
        [BoxGroup, SerializeField] private Image _openLogchainHighlightImage;
        [BoxGroup, SerializeField] private Animation _copyButtonAnimation;
        [BoxGroup, SerializeField] private CanvasGroup _closeBtnCanvasGroup;
        [BoxGroup, SerializeField] private GameObject _expandButton;
